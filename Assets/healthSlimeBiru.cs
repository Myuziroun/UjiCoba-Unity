...
public class healthSlimeBiru : MonoBehaviour
{
    ...
    [Header("Object Slime Biru")]
    [SerializeField] private GameObject slimeBiruObject;
    ...
    public void takeDamage(float _damage)
    {
        ...
        else
        {
            if (!dead)
            {
                ...
                if (GetComponent<SlimeBiru>() != null)
                    GetComponent<SlimeBiru>().enabled = false;
                    slimeBiruObject.gameObject.SetActive(false);
